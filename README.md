...
The mock-ups I used for planning the application are in my "projectPlan" folder inside my 'static' folder under the names **ProjectWireframe_1.png** (ProjectWireframe_1.png), **ProjectWireframe_2.png), **ProjectWireframe_3.png** (ProjectWireframe_3.png), **ProjectWireframe_4.png** (ProjectWireframe_4.png), **ProjectWireframe_5.png** (ProjectWireframe_5.png) and **ProjectWireframe_6.png** (ProjectWireframe_6.png).

My database schema can be found in my "projectPlan" folder inside my 'static' folder as **invitations_dbSchema.pdf** (invitations_dbSchema.pdf).  
